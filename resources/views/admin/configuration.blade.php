	...
	<dl>
		...
		<dd>
			<select name="maintenance">
				<option value="Yes" @if(opt('maintenance', 'No') == 'Yes') selected @endif>Yes</option>
				<option value="No" @if(opt('maintenance', 'No') == 'No') selected @endif>No</option>
			</select>
		</dd>
	...
	<dl>
		...
		<dd>
			<select name="hide_creator_types" id="hideCreatorTypes" class="form-control">
				<option value="1" @if(opt('hide_creator_types') == 1) selected @endif>Show Only Creators</option>
				<option value="2" @if(opt('hide_creator_types') == 2) selected @endif>Show Only Standard Users</option>
				<option value="3" @if(opt('hide_creator_types') == 3) selected @endif>Show Both</option>
			</select>
		</dd>
		<br>
		...
		<dd>
			<textarea class="form-control" name="bannedUserMessage" placeholder="Message that shows to Banned User">{{ opt('bannedUserMessage') }}</textarea>
		</dd>
	</dl>
	</div>
