...
<nav class="navbar navbar-inverse sidebar" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li @if(isset($active) AND ($active == 'email-templates')) class="active" @endif>
        ...
        <li @if(isset($active) AND ($active == 'notifications')) class="active" @endif>
        ...
        <li @if(isset($active) AND ($active == 'alert')) class="active" @endif>
