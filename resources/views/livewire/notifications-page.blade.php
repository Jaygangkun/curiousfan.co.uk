<div>
    ...
    <hr>
		...
		@elseif($n->type == 'App\Notifications\ProfileApprovedNotification')
                                    
            @lang('v19.profileApproved', [
            ])
			
		@elseif($n->type == 'App\Notifications\ProfileRejectedNotification')
                                    
            @lang('v19.profileRejected', [
            ])                                    

		@elseif($n->type == 'App\Notifications\AdminNotify')
            <b>
            {{ $n->data['title'] }}
            </b>
            <br/>
