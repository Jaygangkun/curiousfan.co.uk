...
<!--	<div class="col-sm-2 d-md-block d-none d-sm-none">
	...
	<div class="col-12 col-sm-12" id="belowCreatePost">
		...
		<!-- <textarea name="text_content" id="createPost" rows="1" class="form-control" placeholder="@lang('post.writeSomething')" required="required" style="height:114px;">{{ $post->text_content }}</textarea> -->
		<br>
		<input type="hidden" class="postType" name="lock_type" value="{{  $post->lock_type }}">
		<input type="hidden" class="textContent" name="text_content" value="{{ $post->text_content}}">
		<div class="row">
