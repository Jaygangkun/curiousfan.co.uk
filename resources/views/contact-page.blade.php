            ...
            <form method="POST" action="{{ route('contact-form-process') }}" name="report-content-form">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <input type="text" name="your_name" placeholder="@lang('Name')" class="form-control" value="{{old('your_name')}}"/>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <input type="text" name="your_email" placeholder="@lang('Email')" class="form-control" value="{{old('your_email')}}"/>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <input type="text" name="your_subject" placeholder="@lang('Subject')" class="form-control" value="{{old('your_subject')}}"/>
                    </div>
                </div>
                <br>
