				...
				<div class="col-12 col-sm-4 col-md-3 col-lg-2 mb-1 mb-sm-0">
					<div class="customdv " style="position: relative">
						...
						@if($profile->user->isOnline()) 
							<div class = "profilePicOnline " data-toggle="tooltip" title="I'm online!"></div>
						@endif 
						@if($profile->user_id == auth()->user()->id)
		...
		<div class="row">
			...
			<div class="col-12 col-md-8">
				...
				<div class="text-center noMorePostsMsg d-none mb-5" >
					<div class="card shadow p-3" style="padding: 10px; border: 2px solid #FFFFFF;border-radius: 11px;">
