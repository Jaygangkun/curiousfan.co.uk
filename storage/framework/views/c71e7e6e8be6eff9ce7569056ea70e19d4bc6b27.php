...
} elseif ($_instance->childHasBeenRendered('ByS2kYH')) {
    $componentId = $_instance->getRenderedChildComponentId('ByS2kYH');
    $componentTag = $_instance->getRenderedChildComponentTagName('ByS2kYH');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ByS2kYH');
} else {
    $response = \Livewire\Livewire::mount('notifications-icon');
    $dom = $response->dom;
    $_instance->logRenderedChild('ByS2kYH', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('9peQYvo')) {
    $componentId = $_instance->getRenderedChildComponentId('9peQYvo');
    $componentTag = $_instance->getRenderedChildComponentTagName('9peQYvo');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9peQYvo');
} else {
    $response = \Livewire\Livewire::mount('unread-messages-count');
    $dom = $response->dom;
    $_instance->logRenderedChild('9peQYvo', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('dMl3cog')) {
    $componentId = $_instance->getRenderedChildComponentId('dMl3cog');
    $componentTag = $_instance->getRenderedChildComponentTagName('dMl3cog');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dMl3cog');
} else {
    $response = \Livewire\Livewire::mount('search-creators');
    $dom = $response->dom;
    $_instance->logRenderedChild('dMl3cog', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php endif; ?><?php /**PATH /home/jr5az3t0ng0l/public_html/resources/views/partials/topnavi.blade.php ENDPATH**/ ?>