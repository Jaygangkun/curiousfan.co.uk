...
} elseif ($_instance->childHasBeenRendered('ju79Vmm')) {
    $componentId = $_instance->getRenderedChildComponentId('ju79Vmm');
    $componentTag = $_instance->getRenderedChildComponentTagName('ju79Vmm');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ju79Vmm');
} else {
    $response = \Livewire\Livewire::mount('message');
    $dom = $response->dom;
    $_instance->logRenderedChild('ju79Vmm', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ay8h3a64vt1a/public_html/resources/views/messages/inbox.blade.php ENDPATH**/ ?>