...
} elseif ($_instance->childHasBeenRendered('tMoOGbe')) {
    $componentId = $_instance->getRenderedChildComponentId('tMoOGbe');
    $componentTag = $_instance->getRenderedChildComponentTagName('tMoOGbe');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tMoOGbe');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('tMoOGbe', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jr5az3t0ng0l/public_html/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>