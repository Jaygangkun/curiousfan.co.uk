...
<nav class="navbar navbar-inverse sidebar" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(isset($active) AND ($active == 'block-report-users')): ?> class="active" <?php endif; ?>>
        ...
        <li <?php if(isset($active) AND ($active == 'website-messages')): ?> class="active" <?php endif; ?>>
        ...
        <li <?php if(isset($active) AND ($active == 'email-templates')): ?> class="active" <?php endif; ?>>
          <a href="/admin/email-templates"><i class="fa pull-right hidden-xs showopacity fa-envelope"></i> <span>Email Templates</span></a>
        </li>
        ...
        <li <?php if(isset($active) AND ($active == 'subscriptions')): ?> class="active" <?php endif; ?>>
          <a href="/admin/subscriptions"><i class="fa pull-right hidden-xs showopacity  fa-address-card-o"></i> <span>Subscriptions</span></a>
        </li>
        <li <?php if(isset($active) AND ($active == 'tips')): ?> class="active" <?php endif; ?>>
          <a href="/admin/tips"><i class="fa pull-right hidden-xs showopacity  fa-envelope-open"></i> <span>Tips</span></a>
        </li>
        <li <?php if(isset($active) AND ($active == 'notifications')): ?> class="active" <?php endif; ?>>
          <a href="/admin/notifications"><i class="fa pull-right hidden-xs showopacity  fa-bell-o"></i> <span>Notifications</span></a>
        </li>
        <li <?php if(isset($active) AND ($active == 'unlocks')): ?> class="active" <?php endif; ?>>
          <a href="/admin/unlocks"><i class="fa pull-right hidden-xs showopacity  fa-lock"></i> <span>Unlocks</span></a>
        </li>
        <li <?php if(isset($active) AND ($active == 'tx')): ?> class="active" <?php endif; ?>>
          <a href="/admin/tx"><i class="fa pull-right hidden-xs showopacity  fa-credit-card-alt"></i> <span>Transactions</span></a>
        </li>
        ...
        <li <?php if(isset($active) AND ($active == 'alert')): ?> class="active" <?php endif; ?>>
          <a href="/admin/alert-message"><i class="fa pull-right hidden-xs showopacity fa-at"></i> <span>Alert Messages</span></a>
        </li>
...
<?php /**PATH /home/ay8h3a64vt1a/public_html/resources/views/admin/base.blade.php ENDPATH**/ ?>