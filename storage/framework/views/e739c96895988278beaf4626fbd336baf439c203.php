<div class="card mb-4 post-card" data-post-id="<?php echo e($post->id); ?>">

	<div class="row pl-4 pr-4 pt-4">

		<div class="col-3 col-sm-3 col-md-3 col-lg-2">
			<div class="profilePicSmall mt-0 ml-0 mr-2 mb-2 ml-md-2 shadow">
	...
	<?php if(auth()->user()->id == $post->user_id): ?>
		<div class="row pr-5 text-right d-block">
			<h5 class="d-inline">
				<?php if($post->lock_type == "Paid"): ?>
...
</style><?php /**PATH /home/ay8h3a64vt1a/public_html/resources/views/posts/single.blade.php ENDPATH**/ ?>