<div>
    ...
    <hr>
		...
		<?php elseif($n->type == 'App\Notifications\ProfileApprovedNotification'): ?>
                                    
            <?php echo app('translator')->get('v19.profileApproved', [
            ]); ?>
			
		<?php elseif($n->type == 'App\Notifications\ProfileRejectedNotification'): ?>
                                    
            <?php echo app('translator')->get('v19.profileRejected', [
            ]); ?>                                    

		<?php elseif($n->type == 'App\Notifications\AdminNotify'): ?>
            <b>
            <?php echo e($n->data['title']); ?>

            </b>
            <br/>
            <span>
            <?php echo e($n->data['msg']); ?>
...
<?php /**PATH /home/ay8h3a64vt1a/public_html/resources/views/livewire/notifications-page.blade.php ENDPATH**/ ?>