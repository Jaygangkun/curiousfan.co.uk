...
<div class="leave-tip mt-2 d-none" data-post="<?php echo e($post->id); ?>">
    <form method="POST" action="<?php echo e(route('sendTip', ['post' => $post->id])); ?>" name="tipFrm-<?php echo e($post->id); ?>">
        ...
        <div class="col-6 col-sm-6 col-md-3">
            <input name="tipAmountForPost-<?php echo e($post->id); ?>" type="number" class="form-control" placeholder="<?php echo app('translator')->get('general.minTip'); ?> <?php echo e(opt('payment-settings.currency_symbol') . number_format($post->profile->minTip,2)); ?>" min="<?php echo e($post->profile->minTip); ?>" required>
        </div>
        <div class="col-6 col-sm-6 col-md-3">
...
<?php endif; ?><?php /**PATH /home/ay8h3a64vt1a/public_html/resources/views/tips/tip-form.blade.php ENDPATH**/ ?>