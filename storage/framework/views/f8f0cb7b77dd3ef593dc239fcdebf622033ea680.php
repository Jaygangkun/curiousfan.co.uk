            ...
            <form method="POST" action="<?php echo e(route('contact-form-process')); ?>" name="report-content-form">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <input type="text" name="your_name" placeholder="<?php echo app('translator')->get('your name'); ?>" class="form-control" value="<?php echo e(old('your_name')); ?>"/>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <input type="text" name="your_email" placeholder="<?php echo app('translator')->get('your email'); ?>" class="form-control" value="<?php echo e(old('your_email')); ?>"/>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <input type="text" name="your_subject" placeholder="<?php echo app('translator')->get('subject'); ?>" class="form-control" value="<?php echo e(old('your_subject')); ?>"/>
                    </div>
                </div>
                <br>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jr5az3t0ng0l/public_html/resources/views/contact-page.blade.php ENDPATH**/ ?>