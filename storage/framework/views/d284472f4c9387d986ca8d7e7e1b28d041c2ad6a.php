...
<div class="row">
	...
	<dl>
		...
		<dt>Maintenance Settings?</dt>
		<dd>
			<select name="maintenance">
				<option value="Yes" <?php if(opt('maintenance', 'No') == 'Yes'): ?> selected <?php endif; ?>>Yes</option>
				<option value="No" <?php if(opt('maintenance', 'No') == 'No'): ?> selected <?php endif; ?>>No</option>
			</select>
		</dd>
	...
	<div class="col-xs-12 col-md-6">
	<dl>
		<dt>Show / Hide User Type on Explore Page</dt>
		<dd>
			<select name="hide_creator_types" id="hideCreatorTypes" class="form-control">
				<option value="1" <?php if(opt('hide_creator_types') == 1): ?> selected <?php endif; ?>>Show Only Creators</option>
				<option value="2" <?php if(opt('hide_creator_types') == 2): ?> selected <?php endif; ?>>Show Only Standard Users</option>
				<option value="3" <?php if(opt('hide_creator_types') == 3): ?> selected <?php endif; ?>>Show Both</option>
			</select>
		</dd>
		<br>
		...
		<br>
		<dt>Banned User Message</dt>
		<dd>
			<textarea class="form-control" name="bannedUserMessage" placeholder="Message that shows to Banned User"><?php echo e(opt('bannedUserMessage')); ?></textarea>
		</dd>
	</dl>
	</div>
...
<div class="row">
	...
	<div class="col-xs-12 col-md-6">
		<div class="box">
			...
			<br>
			<dt>Form Logo (max 300x300px)</dt>
			<dd><input type="file" name="form_logo" class="form-control"></dd>
			<br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ay8h3a64vt1a/public_html/resources/views/admin/configuration.blade.php ENDPATH**/ ?>