...
<div class="card mb-4 p-4 p-md-0 mdits">
<div class="row">
	<style>
...
<!--	<div class="col-sm-2 d-md-block d-none d-sm-none">
	...
	<div class="col-12 col-sm-12" id="belowCreatePost">
		<div id="creatEditablePost" class="inputor" contentEditable="true" data-placeholder="Post something.....">
		<?php echo $post->text_content; ?>

		</div>
		<!-- <textarea name="text_content" id="createPost" rows="1" class="form-control" placeholder="<?php echo app('translator')->get('post.writeSomething'); ?>" required="required" style="height:114px;"><?php echo e($post->text_content); ?></textarea> -->
		<br>
		<input type="hidden" class="postType" name="lock_type" value="<?php echo e($post->lock_type); ?>">
		<input type="hidden" class="textContent" name="text_content" value="<?php echo e($post->text_content); ?>">
		<div class="row">
			<div class="col-12 col-sm-12 col-md-8">
				...
				<input type="file" name="imageUpload[]" accept="image/*" class="multipleImgUpload with-preview d-none" multiple="multiple" data-maxfile="10240" maxlength="5" data-maxsize="5120">
				<input type="file" name="videoUpload" accept="video/mp4,video/webm,video/ogg,video/quicktime" class="videoFileUpload d-none">
				<input type="file" name="audioUpload" accept="audio/mpeg" class="audioFileUpload d-none">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ay8h3a64vt1a/public_html/resources/views/posts/edit-post.blade.php ENDPATH**/ ?>